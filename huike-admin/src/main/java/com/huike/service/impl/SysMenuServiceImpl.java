...
import com.huike.domain.system.vo.MetaVo;
import com.huike.domain.system.vo.RouterVo;
import com.huike.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<SysMenu> selectMenuTreeByUserId(Long userId) {
        ...
        if (CurrentUserHolder.isAdmin(userId)) {
